...
public class PrismFixedPediaEntryCreator
{
    ...
    public PrismFixedPediaEntryCreator(string name, PrismPediaCategoryType categoryType, LocalizedString titleLocalized, LocalizedString descriptionLocalized)
    {
        this.name = name;
