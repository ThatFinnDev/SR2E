...
{
    public static GameObject SpawnGadgetObject(this GameObject obj, Vector3 pos, Quaternion rot)
    {
        GameObject gadget =
    ...
    public static GameObject SpawnGadgetObject(this GameObject obj, Vector3 pos) =>
        SpawnGadgetObject(obj, pos, Quaternion.identity);

    public static GameObject SpawnGadgetFromDefinition(this GadgetDefinition obj, Vector3 pos, Quaternion rot) =>
        SpawnGadgetObject(obj.prefab, pos, rot);

    public static GameObject SpawnGadgetAtFacing(this GadgetDefinition obj, Vector3 pos) =>
        SpawnGadgetObject(obj.prefab, pos, Quaternion.identity);internal static Gadget RaycastForGadget()
    {
    ...
    public struct CreateGadgetParams
    {
        ...
        public CreateGadgetParams() : this(PurchaseCost.CreateEmpty()) {} // Default Constructor
        ...
        public CreateGadgetParams(PurchaseCost cost, GadgetDefinition.Types type, bool buyInPairs) : this(cost, type, buyInPairs, false) {}
        public CreateGadgetParams(PurchaseCost cost, GadgetDefinition.Types type, bool buyInPairs, bool noPickup) : this(cost, type, buyInPairs, noPickup, Int32.MaxValue) {}
        public CreateGadgetParams(PurchaseCost cost, GadgetDefinition.Types type, bool buyInPairs, bool noPickup, int countLimit) : this(cost, type, buyInPairs, noPickup, countLimit, null) {}

        public CreateGadgetParams(PurchaseCost cost, GadgetDefinition.Types type, bool buyInPairs, bool noPickup, int countLimit, Sprite icon)
        {
            this.cost = cost;
    ...
    public static GadgetDefinition CreateGadget(string name, GameObject prefab, CreateGadgetParams parameters = default)
    {
