...
public static partial class CottonLibrary
{
    public static class Spawning
    {
        ...
        {
            Default,
            [Obsolete("Doesn't work!")] ReplacementBasedSpawning
        }
        ...
        public static void MakeSpawnableInZones(IdentifiableType ident, DirectedActorSpawner.TimeWindow timeWindow,
            ...
            MakeSpawnableInZones(ident, timeWindow, zones, weight, spawnerTargets, SpawningMode.Default,
                RequiredConditions.None, Array.Empty<string>());

        public static void MakeSpawnableInZones(IdentifiableType ident, DirectedActorSpawner.TimeWindow timeWindow,
            SpawnLocations zones, float weight, SpawnerTypes spawnerTargets, SpawningMode mode,
            RequiredConditions requiredConditions) =>
            MakeSpawnableInZones(ident, timeWindow, zones, weight, spawnerTargets, mode, requiredConditions,
                Array.Empty<string>());
