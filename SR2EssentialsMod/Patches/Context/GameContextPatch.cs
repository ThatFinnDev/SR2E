    ...
    internal static void Postfix(GameContext __instance)
    {
        ...
        if (!SR2EEntryPoint.addedButtons)
        {
            ...
            if (!SR2EConsole.cheatsEnabledOnSave)
                ...
                {
                    SR2EEntryPoint.cheatMenuButton = new CustomPauseMenuButton(AddTranslationFromSR2E("buttons.cheatmenu.label", "b.button_cheatmenu_sr2e", "UI"), 4, (System.Action)(() => { SR2ECheatMenu.Open(); }));
